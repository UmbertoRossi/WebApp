...
<body>
    ...
    <div class="mx-auto" style="background-color: white;">
        <div class="btn-group-vertical" style="margin: 25px;">
            ...
            <div class="mx-auto" style="margin-bottom: 20px; margin-top:120px ">
                <a class="btn btn-outline-dark" href="clients"> Clienti</a>
                <a class="btn btn-outline-dark" href="projects">Progetti</a>
                <a class="btn btn-outline-dark" href="users">Utenti</a>
                <a class="btn btn-outline-dark" href="orders">Ordini</a>
            </div>
            <div class="mx-auto ">
